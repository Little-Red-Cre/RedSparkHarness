...
- `@deepseek-ai/dsh-rsh` — 需要 `agentDefaultModel` · `agentPresets` · `agents` · `commands` · `llm` · `permissionPresets` · `sessions`（[`packages/bundle/rsh/src/index.ts`](../packages/bundle/rsh/src/index.ts)）
