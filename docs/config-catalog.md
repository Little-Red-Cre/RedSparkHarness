...
Requires: `goals` · `agents` · `sessions` · `sessionPersistence` · `tools` · `agentPresets` · `permissionPresets` · `sessionTitle` · `workspaceRegistry`
...
Source: [`packages/automation/task-scheduler/src/index.ts:18`](../packages/automation/task-scheduler/src/index.ts)
...
- `@deepseek-ai/dsh-rsh` — requires `agentDefaultModel` · `agents` · `commands` · `llm` · `permissionPresets` · `planMode` · `rshStartup` · `sessionQuery` · `sessions` ([`packages/bundle/rsh/src/index.ts`](../packages/bundle/rsh/src/index.ts))
