...
- `@deepseek-ai/dsh-rsh` — requires `agentDefaultModel` · `agentPresets` · `agents` · `commands` · `llm` · `permissionPresets` · `sessions` ([`packages/bundle/rsh/src/index.ts`](../packages/bundle/rsh/src/index.ts))
