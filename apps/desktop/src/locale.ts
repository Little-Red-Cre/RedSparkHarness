...
export const zh = {
  ...
  externalLinkFailed: '请检查系统是否已设置默认浏览器，然后再次点击登录链接。',
  updateCheckTitle: '检查更新',
  updateCurrent: '当前已是最新版本。',
  updateTitle: 'RedSpark Harness 更新',
  ...
  pluginWindowTitle: 'RedSpark Harness — 桌面插件',
