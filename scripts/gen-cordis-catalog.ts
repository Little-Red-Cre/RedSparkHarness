...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  pet: 'client-side desktop-pet registry and preference service — packages/client/ui-pet/README.md owns the API',
...
export const EVENT_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  'pet/change': 'client-face desktop-pet registry and preference signal — packages/client/ui-pet/README.md owns the API',
}
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  CreateTaskRequest: 'automation.md',
  SchedulerOwner: 'automation.md',
  SchedulerSnapshot: 'automation.md',
  TaskNotice: 'automation.md',
  Agent: 'core.md',
  ...
  AuthorizationEntryView: 'settings.md',
  AuthorizationFrame: 'settings.md',
  AuthorizationAttemptId: 'settings.md',
  AuthorizationPromptId: 'settings.md',
