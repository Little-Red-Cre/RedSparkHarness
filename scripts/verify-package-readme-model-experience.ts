...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-pet': { kind: 'none', reason: 'Browser-side companion presentation and preferences; registers nothing model-facing.' },
  ...
  'packages/bundle/rsh': { kind: 'none', reason: 'The terminal submits ordinary user messages; its selected Agent preset owns prompts and tools.' },
