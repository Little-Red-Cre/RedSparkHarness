...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  {
    key: 'conversation.pet',
    kind: 'single',
    scope: 'session-maybe',
    summary: 'Optional state-aware companion, placed by Conversation and implemented by another plugin.',
    doc: 'Optional state-aware companion, placed by Conversation and implemented by another plugin.',
    registerOptions: [],
    ownerProps: [
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-pet PetSettingsRow id \'personalization-pet\'',
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'sidebar.settings\' (client-ui-settings-general), so it exists while that entry is mounted',
    occupants: [
      'task-scheduler SchedulerPanel id \'task-scheduler\'',
  ...
  },
  {
    ...
    kind: 'list',
    scope: 'root',
    summary: 'Optional primary shortcuts above New Session, with the same column geometry.',
    doc: 'Optional primary shortcuts above New Session, with the same column geometry.',
    registerOptions: [
      {
        name: 'id',
        requirement: 'required',
    ...
    declaredBy: 'an entry in \'sidebar\' (client-ui-sidebar), so it exists while that entry is mounted',
    occupants: [
      'task-scheduler NoticePanel id \'task-reminders\'',
    ],
    replaceRisk: 'none',
